...
const WhyNulvex = () => {
  ...
  return (
    <section className="py-16 px-7 border-t border-b" style={{ borderColor: C.border }}>
      <div className="max-w-7xl mx-auto justify-center items-center gap-14 items-center">
        ...
        <div className="grid grid-cols-3 place-items-center sm:grid-cols-2 gap-6">
          {items.map((item, i) => (
            <div key={i} className="flex gap-3">
              <span className="text-[11px] font-bold pt-0.5" style={{ color: C.cyan, fontFamily: "monospace" }}>
                {String(i + 1).padStart(2, "0")}
              </span>
              <div>
                <h4 className="text-sm font-semibold text-white mb-1">{item.title}</h4>
                <p className="text-[12.5px] leading-relaxed" style={{ color: C.muted2 }}>{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12 pb-11">
      <div className="max-w-xs">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-7 h-7 rounded-md flex items-center justify-center" style={{ background: C.text }}>
            <ShieldAlert size={15} color={C.void} />
          </div>
          <span className="text-lg font-bold tracking-tight text-white uppercase">NULVEX</span>
        </div>
        <p className="text-xs leading-relaxed" style={{ color: C.muted }}>
          The threat intelligence platform for researchers, developers, and security teams who need signal, not noise.
        </p>
      </div>
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-10">
        <div>
          <h5 className="text-[10px] font-bold uppercase tracking-widest mb-4" style={{ color: C.muted2 }}>Platform</h5>
        ...
        <div>
          <h5 className="text-[10px] font-bold uppercase tracking-widest mb-4" style={{ color: C.muted2 }}>Company</h5>
          <ul className="text-xs space-y-2.5" style={{ color: C.muted }}>
        ...
        <div>
          <h5 className="text-[10px] font-bold uppercase tracking-widest mb-4" style={{ color: C.muted2 }}>Legal</h5>
          <ul className="text-xs space-y-2.5" style={{ color: C.muted }}>
